# Deploying Rock and Fluid Sample DDMS connected to Azure Data Manager for Energy (ADME)

This guide will walk you through deploying a Rock and Fluid Sample (RAFS) DDMS integrated with an Azure Data Manager for Energy (ADME) instance using Azure Container Apps (Quick-deploy) or Azure Kubernetes Service (AKS).
